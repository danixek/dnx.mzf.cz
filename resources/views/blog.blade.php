...
<head>
    ...
    <link rel="icon" href="DEVportfolio/logo/dnx-logo_mini.ico" type="image/x-icon">
...
<body>
    ...
    <header>
        ...
        {{-- Navigační menu --}}
        @import('portfolio/partials/navbar.php');


        <!-- Sekce domů - speciální verze bez citátů -->
        <section id="home" class="{{ Utils::getBgClass() }} text-center text-white pt-4">
    ...
    <main>
        ...
        <?php if (!isset($_GET['post'])) { ?>
            <section id="blog" class="{{ Utils::getBgClass() }} py-5 text-white">
                <div class="container">
                    <div class="row g-3">
                        ...
                        <?php
                        require 'DEVportfolio/blog/lib/parsedown.php';
                        require 'DEVportfolio/blog/lib/spyc.php';
                        $Parsedown = new Parsedown();

                        $files = glob(__DIR__ . "/DEVportfolio/blog/posts/*.md");
                        if (empty($files)) {
                            ...
                            <a href="?post=<?= urlencode($filename) ?>"
                                ...
                                <div class="card bg-dark text-light flex-fill">
                                    <div class="ratio ratio-16x9">
                                        <img src="DEVportfolio/blog/posts/thumbs/<?= htmlspecialchars($image) ?>"
            ...
            <section id="blog" class="{{ Utils::getBgClass() }}text-white py-5">
                <?php
                require 'DEVportfolio/blog/lib/parsedown.php';
                require 'DEVportfolio/blog/lib/spyc.php';
                ...
                $path = __DIR__ . "/DEVportfolio/blog/posts/$post.md";
                ?>
                <div class="container">
                        ...
                        <div class="col-12 content-column">
                            <div class="ms-2">
                                ...
                                if (file_exists($path)) {
                                    ...
                                    ?>
                        <div class="col-10 text-center m-4">
                            <div class="ratio ratio-16x9">
                                <img src="DEVportfolio/blog/posts/thumbs/<?= htmlspecialchars($image) ?>" alt="<?php if (!empty($title)) {
