    ...
    <div class="container align-items-center">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 col-md-4 order-2 order-md-2 text-center text-md-end">
                <img src="DEVportfolio/img/profile.jpg" alt="O mně"
            ...
            <div class="collapse order-3" id="collapseAbout">
                ...
                <div class="row">
                    <div class="col-md-4 col-12 order-1 text-center">
                        <img src="DEVportfolio/img/library.jpg" class="img-fluid m-0 me-1 mt-4" loading="lazy" />
                        <a href="library.php" class="d-inline-block mt-2 collapse-link btn-link">[Knihovna - Easter
                            egg]</a>
                    </div>
            ...
            <div class="mt-4 order-4 row d-flex align-items-center" style="padding-right: 0px;">
                ...
                <div class="justify-content-end ms-auto col-6 text-end d-flex align-items-center">
                    <div class="btn-group">
                        <a href="/DEVportfolio/CV_Csharp_Daniel-Kefurt.pdf" download
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark bg-dark">
                            <li>
                                <a class="dropdown-item d-flex align-items-center"
                                    href="/DEVportfolio/CV_Csharp_Daniel-Kefurt.pdf" target="_blank"
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center"
                                    href="/DEVportfolio/CV_Csharp_Daniel-Kefurt_OLD.pdf" download>
                                    <i class="bi bi-download me-2"></i> Stáhnout staré CV
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center"
                                    href="/DEVportfolio/CV_Csharp_Daniel-Kefurt_OLD.pdf">
