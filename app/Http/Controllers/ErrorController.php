...
class ErrorController extends Controller
{
    public function show(Request $request, $code = 404)
    {
        ...
        Log::channel('visits')->info($logLine); // channel 'visits' musí být v config/logging.php

        $errors = [
            403 => ['title' => 'Přístup zamítnut', 'message' => 'Nemáš tu co dělat...'],
            404 => ['title' => 'Nenalezeno', 'message' => 'Stránka nenalezena.'],
        ...
        // Tady vracíme Response s HTTP status code
